...
controller:
  ...
  # additionalExistingSecret existing secret "secret-credentials" and a key inside it named "github-password" should be used in Jcasc as ${github-password}
  additionalExistingSecret: secret-credentials
