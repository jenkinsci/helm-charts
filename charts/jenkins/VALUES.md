...
| [agent.image.tag](./values.yaml#L1005) | string | Tag of the image to pull | `"3355.v388858a_47b_33-14"` |
...
| [controller.installPlugins](./values.yaml#L420) | list | List of Jenkins plugins to install. If you don't want to install plugins, set it to `false` | `["kubernetes:4423.vb_59f230b_ce53","workflow-aggregator:608.v67378e9d3db_1","git:5.10.0","configuration-as-code:2037.v8e5349845172"]` |
