...
| [agent.containerCap](./values.yaml#L1107) | int | Max number of agents to launch for a whole cluster. | `10` |
...
| [agent.image.tag](./values.yaml#L958) | string | Tag of the image to pull | `"3309.v27b_9314fd1a_4-2"` |
...
| [controller.installPlugins](./values.yaml#L405) | list | List of Jenkins plugins to install. If you don't want to install plugins, set it to `false` | `["kubernetes:4340.v345364d31a_2a_","workflow-aggregator:608.v67378e9d3db_1","git:5.7.0","configuration-as-code:1967.va_968e15fd05b_"]` |
