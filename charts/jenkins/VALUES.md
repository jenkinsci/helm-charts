...
| [agent.image.tag](./values.yaml#L1018) | string | Tag of the image to pull | `"3383.vc8881d4b_0e76-1"` |
...
| [controller.installPlugins](./values.yaml#L420) | list | List of Jenkins plugins to install. If you don't want to install plugins, set it to `false` | `["kubernetes:4423.vb_59f230b_ce53","workflow-aggregator:608.v67378e9d3db_1","git:5.10.1","configuration-as-code:2095.vef6db_3a_b_5b_9c"]` |
...
| [controller.sidecars.configAutoReload.image.tag](./values.yaml#L586) | string | Tag for the image that triggers the reload | `"2.8.0"` |
