...
|:----|:-----|:---------|:------------|
| [additionalAgents](./values.yaml#L1220) | object | Configure additional | `{}` |
| [additionalClouds](./values.yaml#L1245) | object |  | `{}` |
| [agent.TTYEnabled](./values.yaml#L1125) | bool | Allocate pseudo tty to the side container | `false` |
| [agent.additionalContainers](./values.yaml#L1173) | list | Add additional containers to the agents | `[]` |
| [agent.alwaysPullImage](./values.yaml#L1018) | bool | Always pull agent container image before build | `false` |
| [agent.annotations](./values.yaml#L1169) | object | Annotations to apply to the pod | `{}` |
| [agent.args](./values.yaml#L1119) | string | Arguments passed to command to execute | `"${computer.jnlpmac} ${computer.name}"` |
| [agent.command](./values.yaml#L1117) | string | Command to execute when side container starts | `nil` |
| [agent.componentName](./values.yaml#L986) | string |  | `"jenkins-agent"` |
| [agent.connectTimeout](./values.yaml#L1167) | int | Timeout in seconds for an agent to be online | `100` |
| [agent.containerCap](./values.yaml#L1127) | int | Max number of agents to launch for a whole cluster. | `10` |
| [agent.customJenkinsLabels](./values.yaml#L983) | list | Append Jenkins labels to the agent | `[]` |
| [agent.defaultsProviderTemplate](./values.yaml#L935) | string | The name of the pod template to use for providing default values | `""` |
| [agent.directConnection](./values.yaml#L989) | bool |  | `false` |
| [agent.disableDefaultAgent](./values.yaml#L1191) | bool | Disable the default Jenkins Agent configuration | `false` |
| [agent.enabled](./values.yaml#L933) | bool | Enable Kubernetes plugin jnlp-agent podTemplate | `true` |
| [agent.envVars](./values.yaml#L1100) | list | Environment variables for the agent Pod | `[]` |
| [agent.garbageCollection.enabled](./values.yaml#L1136) | bool | When enabled, Jenkins will periodically check for orphan pods that have not been touched for the given timeout period and delete them. | `false` |
| [agent.garbageCollection.namespaces](./values.yaml#L1138) | string | Namespaces to look at for garbage collection, in addition to the default namespace defined for the cloud. One namespace per line. | `""` |
| [agent.garbageCollection.timeout](./values.yaml#L1143) | int | Timeout value for orphaned pods | `300` |
| [agent.hostNetworking](./values.yaml#L997) | bool | Enables the agent to use the host network | `false` |
| [agent.idleMinutes](./values.yaml#L1146) | int | Allows the Pod to remain active for reuse until the configured number of minutes has passed since the last step was executed on it | `0` |
| [agent.image.registry](./values.yaml#L974) | string | Registry to pull the agent jnlp image from | `""` |
| [agent.image.repository](./values.yaml#L976) | string | Repository to pull the agent jnlp image from | `"jenkins/inbound-agent"` |
| [agent.image.tag](./values.yaml#L978) | string | Tag of the image to pull | `"3355.v388858a_47b_33-3"` |
| [agent.imagePullSecretName](./values.yaml#L985) | string | Name of the secret to be used to pull the image | `nil` |
| [agent.inheritYamlMergeStrategy](./values.yaml#L1165) | bool | Controls whether the defined yaml merge strategy will be inherited if another defined pod template is configured to inherit from the current one | `false` |
| [agent.instanceCap](./values.yaml#L1129) | int | Max number of agents to launch for this type of agent | `2147483647` |
| [agent.jenkinsTunnel](./values.yaml#L951) | string | Overrides the Kubernetes Jenkins tunnel | `nil` |
| [agent.jenkinsUrl](./values.yaml#L947) | string | Overrides the Kubernetes Jenkins URL | `nil` |
| [agent.jnlpregistry](./values.yaml#L971) | string | Custom registry used to pull the agent jnlp image from | `nil` |
| [agent.kubernetesConnectTimeout](./values.yaml#L957) | int | The connection timeout in seconds for connections to Kubernetes API. The minimum value is 5 | `5` |
| [agent.kubernetesReadTimeout](./values.yaml#L959) | int | The read timeout in seconds for connections to Kubernetes API. The minimum value is 15 | `15` |
| [agent.livenessProbe](./values.yaml#L1008) | object |  | `{}` |
| [agent.maxRequestsPerHostStr](./values.yaml#L961) | string | The maximum concurrent connections to Kubernetes API | `"32"` |
| [agent.namespace](./values.yaml#L967) | string | Namespace in which the Kubernetes agents should be launched | `nil` |
| [agent.nodeSelector](./values.yaml#L1111) | object | Node labels for pod assignment | `{}` |
| [agent.nodeUsageMode](./values.yaml#L981) | string |  | `"NORMAL"` |
| [agent.podLabels](./values.yaml#L969) | object | Custom Pod labels (an object with `label-key: label-value` pairs) | `{}` |
| [agent.podName](./values.yaml#L1131) | string | Agent Pod base name | `"default"` |
| [agent.podRetention](./values.yaml#L1027) | string |  | `"Never"` |
| [agent.podTemplates](./values.yaml#L1201) | object | Configures extra pod templates for the default kubernetes cloud | `{}` |
| [agent.privileged](./values.yaml#L991) | bool | Agent privileged container | `false` |
| [agent.resources](./values.yaml#L999) | object | Resources allocation (Requests and Limits) | `{"limits":{"cpu":"512m","memory":"512Mi"},"requests":{"cpu":"512m","memory":"512Mi"}}` |
| [agent.restrictedPssSecurityContext](./values.yaml#L1024) | bool | Set a restricted securityContext on jnlp containers | `false` |
| [agent.retentionTimeout](./values.yaml#L963) | int | Time in minutes after which the Kubernetes cloud plugin will clean up an idle worker that has not already terminated | `5` |
| [agent.runAsGroup](./values.yaml#L995) | string | Configure container group | `nil` |
| [agent.runAsUser](./values.yaml#L993) | string | Configure container user | `nil` |
| [agent.secretEnvVars](./values.yaml#L1104) | list | Mount a secret as environment variable | `[]` |
| [agent.serviceAccount](./values.yaml#L943) | string | Override the default service account | `serviceAccountAgent.name` if `agent.useDefaultServiceAccount` is `true` |
| [agent.showRawYaml](./values.yaml#L1031) | bool |  | `true` |
| [agent.sideContainerName](./values.yaml#L1121) | string | Side container name | `"jnlp"` |
| [agent.skipTlsVerify](./values.yaml#L953) | bool | Disables the verification of the controller certificate on remote connection. This flag correspond to the "Disable https certificate check" flag in kubernetes plugin UI | `false` |
| [agent.usageRestricted](./values.yaml#L955) | bool | Enable the possibility to restrict the usage of this agent to specific folder. This flag correspond to the "Restrict pipeline support to authorized folders" flag in kubernetes plugin UI | `false` |
| [agent.useDefaultServiceAccount](./values.yaml#L939) | bool | Use `serviceAccountAgent.name` as the default value for defaults template `serviceAccount` | `true` |
| [agent.volumes](./values.yaml#L1038) | list | Additional volumes | `[]` |
| [agent.waitForPodSec](./values.yaml#L965) | int | Seconds to wait for pod to be running | `600` |
| [agent.websocket](./values.yaml#L988) | bool | Enables agent communication via websockets | `false` |
| [agent.workingDir](./values.yaml#L980) | string | Configure working directory for default agent | `"/home/jenkins/agent"` |
| [agent.workspaceVolume](./values.yaml#L1073) | object | Workspace volume (defaults to EmptyDir) | `{}` |
| [agent.yamlMergeStrategy](./values.yaml#L1163) | string | Defines how the raw yaml field gets merged with yaml definitions from inherited pod templates. Possible values: "merge" or "override" | `"override"` |
| [agent.yamlTemplate](./values.yaml#L1152) | string | The raw yaml of a Pod API Object to merge into the agent spec | `""` |
| [awsSecurityGroupPolicies.enabled](./values.yaml#L1378) | bool |  | `false` |
| [awsSecurityGroupPolicies.policies[0].name](./values.yaml#L1380) | string |  | `""` |
| [awsSecurityGroupPolicies.policies[0].podSelector](./values.yaml#L1382) | object |  | `{}` |
| [awsSecurityGroupPolicies.policies[0].securityGroupIds](./values.yaml#L1381) | list |  | `[]` |
| [checkDeprecation](./values.yaml#L1375) | bool | Checks if any deprecated values are used | `true` |
...
| [controller.backendconfig.annotations](./values.yaml#L791) | object | backendconfig annotations | `{}` |
| [controller.backendconfig.apiVersion](./values.yaml#L785) | string | backendconfig API version | `"extensions/v1beta1"` |
| [controller.backendconfig.enabled](./values.yaml#L783) | bool | Enables backendconfig | `false` |
| [controller.backendconfig.labels](./values.yaml#L789) | object | backendconfig labels | `{}` |
| [controller.backendconfig.name](./values.yaml#L787) | string | backendconfig name | `nil` |
| [controller.backendconfig.spec](./values.yaml#L793) | object | backendconfig spec | `{}` |
...
| [controller.googlePodMonitor.enabled](./values.yaml#L854) | bool |  | `false` |
| [controller.googlePodMonitor.scrapeEndpoint](./values.yaml#L859) | string |  | `"/prometheus"` |
| [controller.googlePodMonitor.scrapeInterval](./values.yaml#L857) | string |  | `"60s"` |
...
| [controller.hostAliases](./values.yaml#L807) | list | Allows for adding entries to Pod /etc/hosts | `[]` |
| [controller.hostNetworking](./values.yaml#L73) | bool |  | `false` |
| [controller.httpsKeyStore.disableSecretMount](./values.yaml#L875) | bool |  | `false` |
| [controller.httpsKeyStore.enable](./values.yaml#L866) | bool | Enables HTTPS keystore on jenkins controller | `false` |
| [controller.httpsKeyStore.fileName](./values.yaml#L883) | string | Jenkins keystore filename which will appear under controller.httpsKeyStore.path | `"keystore.jks"` |
| [controller.httpsKeyStore.httpPort](./values.yaml#L879) | int | HTTP Port that Jenkins should listen to along with HTTPS, it also serves as the liveness and readiness probes port. | `8081` |
| [controller.httpsKeyStore.jenkinsHttpsJksPasswordSecretKey](./values.yaml#L874) | string | Name of the key in the secret that contains the JKS password | `"https-jks-password"` |
| [controller.httpsKeyStore.jenkinsHttpsJksPasswordSecretName](./values.yaml#L872) | string | Name of the secret that contains the JKS password, if it is not in the same secret as the JKS file | `""` |
| [controller.httpsKeyStore.jenkinsHttpsJksSecretKey](./values.yaml#L870) | string | Name of the key in the secret that already has SSL keystore | `"jenkins-jks-file"` |
| [controller.httpsKeyStore.jenkinsHttpsJksSecretName](./values.yaml#L868) | string | Name of the secret that already has SSL keystore | `""` |
| [controller.httpsKeyStore.jenkinsKeyStoreBase64Encoded](./values.yaml#L888) | string | Base64 encoded Keystore content. Keystore must be converted to base64 then being pasted here | `nil` |
| [controller.httpsKeyStore.password](./values.yaml#L885) | string | Jenkins keystore password | `"password"` |
| [controller.httpsKeyStore.path](./values.yaml#L881) | string | Path of HTTPS keystore file | `"/var/jenkins_keystore"` |
...
| [controller.ingress.annotations](./values.yaml#L729) | object | Ingress annotations | `{}` |
| [controller.ingress.apiVersion](./values.yaml#L725) | string | Ingress API version | `"extensions/v1beta1"` |
| [controller.ingress.enabled](./values.yaml#L704) | bool | Enables ingress | `false` |
| [controller.ingress.hostName](./values.yaml#L743) | string | Ingress hostname | `nil` |
| [controller.ingress.labels](./values.yaml#L727) | object | Ingress labels | `{}` |
| [controller.ingress.path](./values.yaml#L739) | string | Ingress path | `nil` |
| [controller.ingress.pathType](./values.yaml#L720) | string |  | `"ImplementationSpecific"` |
| [controller.ingress.paths](./values.yaml#L708) | list | Override for the default Ingress paths | `[]` |
| [controller.ingress.resourceRootUrl](./values.yaml#L745) | string | Hostname to serve assets from | `nil` |
| [controller.ingress.tls](./values.yaml#L747) | list | Ingress TLS configuration | `[]` |
...
| [controller.prometheus.alertingRulesAdditionalLabels](./values.yaml#L840) | object | Additional labels to add to the PrometheusRule object | `{}` |
| [controller.prometheus.alertingrules](./values.yaml#L838) | list | Array of prometheus alerting rules | `[]` |
| [controller.prometheus.enabled](./values.yaml#L823) | bool | Enables prometheus service monitor | `false` |
| [controller.prometheus.metricRelabelings](./values.yaml#L850) | list |  | `[]` |
| [controller.prometheus.prometheusRuleNamespace](./values.yaml#L842) | string | Set a custom namespace where to deploy PrometheusRule resource | `""` |
| [controller.prometheus.relabelings](./values.yaml#L848) | list |  | `[]` |
| [controller.prometheus.scrapeEndpoint](./values.yaml#L833) | string | The endpoint prometheus should get metrics from | `"/prometheus"` |
| [controller.prometheus.scrapeInterval](./values.yaml#L829) | string | How often prometheus should scrape metrics | `"60s"` |
| [controller.prometheus.serviceMonitorAdditionalLabels](./values.yaml#L825) | object | Additional labels to add to the service monitor object | `{}` |
| [controller.prometheus.serviceMonitorNamespace](./values.yaml#L827) | string | Set a custom namespace where to deploy ServiceMonitor resource | `nil` |
...
| [controller.route.annotations](./values.yaml#L802) | object | Route annotations | `{}` |
| [controller.route.enabled](./values.yaml#L798) | bool | Enables openshift route | `false` |
| [controller.route.labels](./values.yaml#L800) | object | Route labels | `{}` |
| [controller.route.path](./values.yaml#L804) | string | Route path | `nil` |
...
| [controller.secondaryingress.annotations](./values.yaml#L765) | object |  | `{}` |
| [controller.secondaryingress.apiVersion](./values.yaml#L763) | string |  | `"extensions/v1beta1"` |
| [controller.secondaryingress.enabled](./values.yaml#L757) | bool |  | `false` |
| [controller.secondaryingress.hostName](./values.yaml#L772) | string |  | `nil` |
| [controller.secondaryingress.labels](./values.yaml#L764) | object |  | `{}` |
| [controller.secondaryingress.paths](./values.yaml#L760) | list |  | `[]` |
| [controller.secondaryingress.tls](./values.yaml#L773) | string |  | `nil` |
...
| [controller.testEnabled](./values.yaml#L862) | bool | Can be used to disable rendering controller test resources when using helm template | `true` |
...
| [helmtest.bats.image.registry](./values.yaml#L1391) | string | Registry of the image used to test the framework | `"docker.io"` |
| [helmtest.bats.image.repository](./values.yaml#L1393) | string | Repository of the image used to test the framework | `"bats/bats"` |
| [helmtest.bats.image.tag](./values.yaml#L1395) | string | Tag of the image to test the framework | `"1.13.0"` |
...
| [networkPolicy.apiVersion](./values.yaml#L1314) | string | NetworkPolicy ApiVersion | `"networking.k8s.io/v1"` |
| [networkPolicy.enabled](./values.yaml#L1309) | bool | Enable the creation of NetworkPolicy resources | `false` |
| [networkPolicy.externalAgents.except](./values.yaml#L1329) | list | A list of IP sub-ranges to be excluded from the allowlisted IP range | `[]` |
| [networkPolicy.externalAgents.ipCIDR](./values.yaml#L1327) | string | The IP range from which external agents are allowed to connect to controller, i.e., 172.17.0.0/16 | `nil` |
| [networkPolicy.internalAgents.allowed](./values.yaml#L1318) | bool | Allow internal agents (from the same cluster) to connect to controller. Agent pods will be filtered based on PodLabels | `true` |
| [networkPolicy.internalAgents.namespaceLabels](./values.yaml#L1322) | object | A map of labels (keys/values) that agents namespaces must have to be able to connect to controller | `{}` |
| [networkPolicy.internalAgents.podLabels](./values.yaml#L1320) | object | A map of labels (keys/values) that agent pods must have to be able to connect to controller | `{}` |
| [persistence.accessMode](./values.yaml#L1284) | string | The PVC access mode | `"ReadWriteOnce"` |
| [persistence.annotations](./values.yaml#L1280) | object | Annotations for the PVC | `{}` |
| [persistence.dataSource](./values.yaml#L1290) | object | Existing data source to clone PVC from | `{}` |
| [persistence.enabled](./values.yaml#L1264) | bool | Enable the use of a Jenkins PVC | `true` |
| [persistence.existingClaim](./values.yaml#L1270) | string | Provide the name of a PVC | `nil` |
| [persistence.labels](./values.yaml#L1282) | object | Labels for the PVC | `{}` |
| [persistence.mounts](./values.yaml#L1302) | list | Additional mounts | `[]` |
| [persistence.size](./values.yaml#L1286) | string | The size of the PVC | `"8Gi"` |
| [persistence.storageClass](./values.yaml#L1278) | string | Storage class for the PVC | `nil` |
| [persistence.subPath](./values.yaml#L1295) | string | SubPath for jenkins-home mount | `nil` |
| [persistence.volumes](./values.yaml#L1297) | list | Additional volumes | `[]` |
| [rbac.create](./values.yaml#L1336) | bool | Whether RBAC resources are created | `true` |
| [rbac.readSecrets](./values.yaml#L1338) | bool | Whether the Jenkins service account should be able to read Kubernetes secrets | `false` |
| [rbac.useOpenShiftNonRootSCC](./values.yaml#L1340) | bool | Whether the Jenkins service account should be able to use the OpenShift "nonroot" Security Context Constraints | `false` |
| [renderHelmLabels](./values.yaml#L30) | bool | Enables rendering of the helm.sh/chart label to the annotations | `true` |
| [serviceAccount.annotations](./values.yaml#L1350) | object | Configures annotations for the ServiceAccount | `{}` |
| [serviceAccount.automountServiceAccountToken](./values.yaml#L1356) | bool | Auto-mount ServiceAccount token | `true` |
| [serviceAccount.create](./values.yaml#L1344) | bool | Configures if a ServiceAccount with this name should be created | `true` |
| [serviceAccount.extraLabels](./values.yaml#L1352) | object | Configures extra labels for the ServiceAccount | `{}` |
| [serviceAccount.imagePullSecretName](./values.yaml#L1354) | string | Controller ServiceAccount image pull secret | `nil` |
| [serviceAccount.name](./values.yaml#L1348) | string |  | `nil` |
| [serviceAccountAgent.annotations](./values.yaml#L1366) | object | Configures annotations for the agent ServiceAccount | `{}` |
| [serviceAccountAgent.automountServiceAccountToken](./values.yaml#L1372) | bool | Auto-mount ServiceAccount token | `true` |
| [serviceAccountAgent.create](./values.yaml#L1360) | bool | Configures if an agent ServiceAccount should be created | `false` |
| [serviceAccountAgent.extraLabels](./values.yaml#L1368) | object | Configures extra labels for the agent ServiceAccount | `{}` |
| [serviceAccountAgent.imagePullSecretName](./values.yaml#L1370) | string | Agent ServiceAccount image pull secret | `nil` |
| [serviceAccountAgent.name](./values.yaml#L1364) | string | The name of the agent ServiceAccount to be used by access-controlled resources | `nil` |
