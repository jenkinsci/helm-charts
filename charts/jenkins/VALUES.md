...
| [agent.image.tag](./values.yaml#L965) | string | Tag of the image to pull | `"3324.vea_eda_e98cd69-1"` |
...
| [controller.sidecars.configAutoReload.image.tag](./values.yaml#L573) | string | Tag for the image that triggers the reload | `"1.30.7"` |
