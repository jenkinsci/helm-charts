...
| [agent.image.tag](./values.yaml#L1015) | string | Tag of the image to pull | `"3355.v388858a_47b_33-22"` |
...
| [controller.installPlugins](./values.yaml#L420) | list | List of Jenkins plugins to install. If you don't want to install plugins, set it to `false` | `["kubernetes:4423.vb_59f230b_ce53","workflow-aggregator:608.v67378e9d3db_1","git:5.10.1","configuration-as-code:2089.v970a_0b_a_8cc6d"]` |
...
| [controller.sidecars.configAutoReload.image.tag](./values.yaml#L586) | string | Tag for the image that triggers the reload | `"2.7.3"` |
