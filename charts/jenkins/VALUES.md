...
|:----|:-----|:---------|:------------|
| [additionalAgents](./values.yaml#L1132) | object | Configure additional | `{}` |
| [additionalClouds](./values.yaml#L1157) | object |  | `{}` |
| [agent.TTYEnabled](./values.yaml#L1052) | bool | Allocate pseudo tty to the side container | `false` |
| [agent.additionalContainers](./values.yaml#L1085) | list | Add additional containers to the agents | `[]` |
| [agent.alwaysPullImage](./values.yaml#L951) | bool | Always pull agent container image before build | `false` |
| [agent.annotations](./values.yaml#L1081) | object | Annotations to apply to the pod | `{}` |
| [agent.args](./values.yaml#L1046) | string | Arguments passed to command to execute | `"${computer.jnlpmac} ${computer.name}"` |
| [agent.command](./values.yaml#L1044) | string | Command to execute when side container starts | `nil` |
| [agent.componentName](./values.yaml#L919) | string |  | `"jenkins-agent"` |
| [agent.connectTimeout](./values.yaml#L1079) | int | Timeout in seconds for an agent to be online | `100` |
| [agent.containerCap](./values.yaml#L1054) | int | Max number of agents to launch | `10` |
...
| [agent.disableDefaultAgent](./values.yaml#L1103) | bool | Disable the default Jenkins Agent configuration | `false` |
| [agent.enabled](./values.yaml#L880) | bool | Enable Kubernetes plugin jnlp-agent podTemplate | `true` |
| [agent.envVars](./values.yaml#L1027) | list | Environment variables for the agent Pod | `[]` |
| [agent.hostNetworking](./values.yaml#L930) | bool | Enables the agent to use the host network | `false` |
| [agent.idleMinutes](./values.yaml#L1059) | int | Allows the Pod to remain active for reuse until the configured number of minutes has passed since the last step was executed on it | `0` |
...
| [agent.nodeSelector](./values.yaml#L1038) | object | Node labels for pod assignment | `{}` |
...
| [agent.podName](./values.yaml#L1056) | string | Agent Pod base name | `"default"` |
| [agent.podRetention](./values.yaml#L954) | string |  | `"Never"` |
| [agent.podTemplates](./values.yaml#L1113) | object | Configures extra pod templates for the default kubernetes cloud | `{}` |
...
| [agent.secretEnvVars](./values.yaml#L1031) | list | Mount a secret as environment variable | `[]` |
| [agent.showRawYaml](./values.yaml#L958) | bool |  | `true` |
| [agent.sideContainerName](./values.yaml#L1048) | string | Side container name | `"jnlp"` |
| [agent.volumes](./values.yaml#L965) | list | Additional volumes | `[]` |
...
| [agent.workspaceVolume](./values.yaml#L1000) | object | Workspace volume (defaults to EmptyDir) | `{}` |
| [agent.yamlMergeStrategy](./values.yaml#L1077) | string | Defines how the raw yaml field gets merged with yaml definitions from inherited pod templates. Possible values: "merge" or "override" | `"override"` |
| [agent.yamlTemplate](./values.yaml#L1066) | string | The raw yaml of a Pod API Object to merge into the agent spec | `""` |
| [awsSecurityGroupPolicies.enabled](./values.yaml#L1283) | bool |  | `false` |
| [awsSecurityGroupPolicies.policies[0].name](./values.yaml#L1285) | string |  | `""` |
| [awsSecurityGroupPolicies.policies[0].podSelector](./values.yaml#L1287) | object |  | `{}` |
| [awsSecurityGroupPolicies.policies[0].securityGroupIds](./values.yaml#L1286) | list |  | `[]` |
| [checkDeprecation](./values.yaml#L1280) | bool | Checks if any deprecated values are used | `true` |
...
| [controller.installPlugins](./values.yaml#L395) | list | List of Jenkins plugins to install. If you don't want to install plugins, set it to `false` | `["kubernetes:4186.v1d804571d5d4","workflow-aggregator:596.v8c21c963d92d","git:5.2.1","configuration-as-code:1775.v810dc950b_514"]` |
...
| [controller.sidecars.configAutoReload.image.tag](./values.yaml#L557) | string | Tag for the image that triggers the reload | `"1.26.0"` |
...
| [helmtest.bats.image.registry](./values.yaml#L1296) | string | Registry of the image used to test the framework | `"docker.io"` |
| [helmtest.bats.image.repository](./values.yaml#L1298) | string | Repository of the image used to test the framework | `"bats/bats"` |
| [helmtest.bats.image.tag](./values.yaml#L1300) | string | Tag of the image to test the framework | `"v1.10.0"` |
...
| [networkPolicy.apiVersion](./values.yaml#L1226) | string | NetworkPolicy ApiVersion | `"networking.k8s.io/v1"` |
| [networkPolicy.enabled](./values.yaml#L1221) | bool | Enable the creation of NetworkPolicy resources | `false` |
| [networkPolicy.externalAgents.except](./values.yaml#L1240) | list | A list of IP sub-ranges to be excluded from the allowlisted IP range | `[]` |
| [networkPolicy.externalAgents.ipCIDR](./values.yaml#L1238) | string | The IP range from which external agents are allowed to connect to controller, i.e., 172.17.0.0/16 | `nil` |
| [networkPolicy.internalAgents.allowed](./values.yaml#L1230) | bool | Allow internal agents (from the same cluster) to connect to controller. Agent pods will be filtered based on PodLabels | `true` |
| [networkPolicy.internalAgents.namespaceLabels](./values.yaml#L1234) | object | A map of labels (keys/values) that agents namespaces must have to be able to connect to controller | `{}` |
| [networkPolicy.internalAgents.podLabels](./values.yaml#L1232) | object | A map of labels (keys/values) that agent pods must have to be able to connect to controller | `{}` |
| [persistence.accessMode](./values.yaml#L1196) | string | The PVC access mode | `"ReadWriteOnce"` |
| [persistence.annotations](./values.yaml#L1192) | object | Annotations for the PVC | `{}` |
| [persistence.dataSource](./values.yaml#L1202) | object | Existing data source to clone PVC from | `{}` |
| [persistence.enabled](./values.yaml#L1176) | bool | Enable the use of a Jenkins PVC | `true` |
| [persistence.existingClaim](./values.yaml#L1182) | string | Provide the name of a PVC | `nil` |
| [persistence.labels](./values.yaml#L1194) | object | Labels for the PVC | `{}` |
| [persistence.mounts](./values.yaml#L1214) | list | Additional mounts | `[]` |
| [persistence.size](./values.yaml#L1198) | string | The size of the PVC | `"8Gi"` |
| [persistence.storageClass](./values.yaml#L1190) | string | Storage class for the PVC | `nil` |
| [persistence.subPath](./values.yaml#L1207) | string | SubPath for jenkins-home mount | `nil` |
| [persistence.volumes](./values.yaml#L1209) | list | Additional volumes | `[]` |
| [rbac.create](./values.yaml#L1246) | bool | Whether RBAC resources are created | `true` |
| [rbac.readSecrets](./values.yaml#L1248) | bool | Whether the Jenkins service account should be able to read Kubernetes secrets | `false` |
| [renderHelmLabels](./values.yaml#L30) | bool | Enables rendering of the helm.sh/chart label to the annotations | `true` |
| [serviceAccount.annotations](./values.yaml#L1258) | object | Configures annotations for the ServiceAccount | `{}` |
| [serviceAccount.create](./values.yaml#L1252) | bool | Configures if a ServiceAccount with this name should be created | `true` |
| [serviceAccount.extraLabels](./values.yaml#L1260) | object | Configures extra labels for the ServiceAccount | `{}` |
| [serviceAccount.imagePullSecretName](./values.yaml#L1262) | string | Controller ServiceAccount image pull secret | `nil` |
| [serviceAccount.name](./values.yaml#L1256) | string |  | `nil` |
| [serviceAccountAgent.annotations](./values.yaml#L1273) | object | Configures annotations for the agent ServiceAccount | `{}` |
| [serviceAccountAgent.create](./values.yaml#L1267) | bool | Configures if an agent ServiceAccount should be created | `false` |
