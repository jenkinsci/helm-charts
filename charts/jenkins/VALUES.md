...
| [controller.installPlugins](./values.yaml#L401) | list | List of Jenkins plugins to install. If you don't want to install plugins, set it to `false` | `["kubernetes:4302.va_756e4b_67715","workflow-aggregator:600.vb_57cdd26fdd7","git:5.6.0","configuration-as-code:1903.v004d55388f30"]` |
...
| [controller.sidecars.configAutoReload.image.tag](./values.yaml#L567) | string | Tag for the image that triggers the reload | `"1.28.1"` |
