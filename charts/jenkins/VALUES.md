...
| [agent.image.tag](./values.yaml#L958) | string | Tag of the image to pull | `"3307.v632ed11b_3a_c7-2"` |
...
| [controller.installPlugins](./values.yaml#L405) | list | List of Jenkins plugins to install. If you don't want to install plugins, set it to `false` | `["kubernetes:4324.vfec199a_33512","workflow-aggregator:608.v67378e9d3db_1","git:5.7.0","configuration-as-code:1963.v24e046127a_3f"]` |
